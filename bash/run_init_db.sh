...
docker run --name sde-pg -p 5432:5432 --rm -e POSTGRES_USER=test_sde -e POSTGRES_PASSWORD=@sde_password012 -e POSTGRES_DB=demo -e PGDATA=/var/lib/postgresql/data/pgdata -v C:/Users/AGNikolaev/Desktop/learning/sde_test_db/sql:/var/lib/postgresql/data -d postgres
